      ...
      <div className="private">
        <div className="row">
         <div className="col-md-6 col-sm-12 col-xs-12 private-left">
            <img src="/img/Private icon.png" alt="wallet" width="6%" className="private_img"/>
        ...
        <div className="private_down">
          <button className="private_button"><span className="private_button_text">Discover More Features</span><img src="/img/arrow-narrow-up-right.png" alt="right-arrow"/></button>
        </div>
      </div>
    </div>
  );
